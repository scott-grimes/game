...
class Input:
    ...
    def __init__(self, **options):
        ...
        self.shifted = False
        self.lastEnterPress = 0.0 #last time enter was pressed
        self.timeToWait = 100 #wait at least 1000ms before you can hit enter again
        self.chatActivated = False
        
    def reset(self):
        #reset the chat value, disable the chat window
        self.value = ''
        self.chatActivated = False
        self.lastEnterPress = pygame.time.get_ticks()
        
    def read(self):
        #accept whatever input the user typed. then reset the chat box
        user_entered_text = self.value[:]
        self.reset()
        return user_entered_text
        
    def enable(self):
        #enable the chat window
        self.chatActivated = True
        self.lastEnterPress = pygame.time.get_ticks()
